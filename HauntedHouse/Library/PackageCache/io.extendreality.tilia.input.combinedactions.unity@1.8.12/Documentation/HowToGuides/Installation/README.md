...
The prefabs in this package provide more complex input actions for more custom outputs. These prefabs can be included in a Unity software project via the [Unity Package Manager].
...
* Adjust the [project manifest file][Project-Manifest] `manifest.json` in a text editor.
  ...
  * Add `io.extendreality.tilia.input.combinedactions.unity` to `dependencies`, stating the latest version.
  ...
  ```json
  {
    ...
    "dependencies": {
      "io.extendreality.tilia.input.combinedactions.unity": "X.Y.Z",
      ...
    }
  }
  ```
...
The `Tilia Input CombinedActions Unity` package will now be available in your Unity project `Packages` directory ready for use in your project.
