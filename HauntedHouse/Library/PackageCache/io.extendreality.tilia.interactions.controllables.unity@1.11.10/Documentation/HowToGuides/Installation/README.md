...
* Adjust the [project manifest file][Project-Manifest] `manifest.json` in a text editor.
  ...
  * Add `io.extendreality.tilia.interactions.controllables.unity` to `dependencies`, stating the latest version.
  ...
  ```json
  {
    ...
    "dependencies": {
      "io.extendreality.tilia.interactions.controllables.unity": "X.Y.Z",
      ...
    }
  }
  ```
...
The `Tilia Interactions Controllables Unity` package will now be available in your Unity project `Packages` directory ready for use in your project.
